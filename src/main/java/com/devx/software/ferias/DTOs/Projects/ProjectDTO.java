...
public class ProjectDTO {
    ...
    private List<ProjectHistoryEntity> historico;
    private List<TaskDTO> proyectoTareas;
    private List<ProjectColaboratorEntity> colaboradores;
    ...
    public List<TaskDTO> getProyectoTareas() {
        return proyectoTareas;
    }

    public void setProyectoTareas(List<TaskDTO> proyectoTareas) {
